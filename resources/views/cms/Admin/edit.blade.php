      ...
      <div class="card-body">
        ...
        <div class="form-group">
          ...
          {{-- <div class="form-group">
            ...
            <input type="password" class="form-control" name="password" value="{{$admin->password}}" id="password"> 
          </div>
          <div class="form-group">
            <label for="cpassword">confirm password</label>
            <input type="password" class="form-control" name="cpassword" value="{{$admin->password}}" id="cpassword"> 
          </div>  --}}
      </div>
      <!-- /.card-body -->
