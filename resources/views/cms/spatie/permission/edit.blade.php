...
@section('small_page',"Edit Permission")
@section('content')
   ...
   <form>
    <div class="form-group">
        ...
        <select id="guard" class="form-control">
            <option @if ($permission->guard_name=="admin")
                selected
            @endif>admin</option>
            <option @if ($permission->guard_name=="user")
                selected
            @endif>user</option>
        </select>
    </div>
    ...
    <div class="form-group">
        <button class="btn btn-primary" onclick="update({{$permission->id}})" class="form-control">update</button>
      </div>
   </form>
</div>
  </div>
...
@section('script')
 <script>
   ...
   function update(id){
    axios.put(`/cms/admin/permission/${id}`,{
